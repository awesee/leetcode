...
[< Previous](../count-sub-islands "Count Sub Islands")
　　　　　　　　　　　　　　　　
[Next >](../count-salary-categories "Count Salary Categories")

## [1906. Minimum Absolute Difference Queries (Medium)](https://leetcode.com/problems/minimum-absolute-difference-queries "查询差绝对值的最小值")
