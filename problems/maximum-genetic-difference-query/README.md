...
[< Previous](../maximum-number-of-points-with-cost "Maximum Number of Points with Cost")
　　　　　　　　　　　　　　　　
[Next >](../users-that-actively-request-confirmation-messages "Users That Actively Request Confirmation Messages")

## [1938. Maximum Genetic Difference Query (Hard)](https://leetcode.com/problems/maximum-genetic-difference-query "查询最大基因差")
