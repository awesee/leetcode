...
[< Previous](../nearest-exit-from-entrance-in-maze "Nearest Exit from Entrance in Maze")
　　　　　　　　　　　　　　　　
[Next >](../minimum-cost-to-reach-destination-in-time "Minimum Cost to Reach Destination in Time")

## [1927. Sum Game (Medium)](https://leetcode.com/problems/sum-game "求和游戏")
