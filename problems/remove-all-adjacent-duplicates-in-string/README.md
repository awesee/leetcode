...
<p>You are given a string <code>s</code>. A <strong>duplicate removal</strong> consists of choosing two adjacent and equal letters and removing them.</p>

<p>We repeatedly make <strong>duplicate removals</strong> on <code>s</code> until we no longer can.</p>

<p>Return <em>the final string after all such duplicate removals have been made</em>. It is guaranteed the answer is <strong>unique</strong>.</p>
