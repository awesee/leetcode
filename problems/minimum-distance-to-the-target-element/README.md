...
[< Previous](../closest-room "Closest Room")
　　　　　　　　　　　　　　　　
[Next >](../splitting-a-string-into-descending-consecutive-values "Splitting a String Into Descending Consecutive Values")

## [1848. Minimum Distance to the Target Element (Easy)](https://leetcode.com/problems/minimum-distance-to-the-target-element "到目标元素的最小距离")
