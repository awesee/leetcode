...
[< Previous](../number-of-ways-to-form-a-target-string-given-a-dictionary "Number of Ways to Form a Target String Given a Dictionary")
　　　　　　　　　　　　　　　　
[Next >](../count-sorted-vowel-strings "Count Sorted Vowel Strings")

## [1640. Check Array Formation Through Concatenation (Easy)](https://leetcode.com/problems/check-array-formation-through-concatenation "能否连接形成数组")
