...
[< Previous](../suspicious-bank-accounts "Suspicious Bank Accounts")
　　　　　　　　　　　　　　　　
[Next >](../seat-reservation-manager "Seat Reservation Manager")

## [1844. Replace All Digits with Characters (Easy)](https://leetcode.com/problems/replace-all-digits-with-characters "将所有数字用字符替换")
