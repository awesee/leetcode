...
<p>Given an array of integers <code>nums</code> and and integer <code>target</code>, return <em>the&nbsp;indices of the two numbers such that they add up to <code>target</code></em>.</p>
